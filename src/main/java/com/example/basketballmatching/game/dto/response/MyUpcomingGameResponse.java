...
public record MyUpcomingGameResponse(
        ...
        @Schema(description = "경기 시작 시각", example = "2026-08-20T15:00:00")
        LocalDateTime startDateTime,

        @Schema(description = "경기 종료 시각", example = "2026-08-20T17:00:00")
        LocalDateTime endDateTime,

        @Schema(description = "경기 정원", example = "6")
        int headCount,

        @Schema(description = "현재 참가 인원", example = "4")
        int participantCount,

        @Schema(description = "경기 모집 상태", example = "RECRUITING")
    ...
    public static MyUpcomingGameResponse fromEntity(ParticipantGameEntity participation, Long requesterId) {

        GameEntity game = participation.getGameEntity();

        return new MyUpcomingGameResponse(
                game.getGameId(),
                game.getTitle(),
                game.getPlaceName(),
                game.getAddress(),
